...
export async function getFeaturedProjects() {
  let featured = await client.getEntries(constants.FEATURED_PROJECTS)
    .then(data => {
...
export async function getAllProjects() {
  let projects = await client.getEntries(constants.ALL_PROJECTS)
    .then(data => {
      delete data['metadata'];
      delete data['sys'];
...
export default { getHeaderLinks, getFooterLinks, getAllProjects, getFeaturedProjects, getAboutContent }